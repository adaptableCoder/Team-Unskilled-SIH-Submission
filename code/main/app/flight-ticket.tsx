			...
			<View className="bg-[#FFF1EF] flex-1 h-[100dvh]">
				<ScrollView className="flex-1" contentContainerStyle={{ padding: 20, flexGrow: 1 }}>
					<View className="mt-6 flex-row gap-2">
						<Ionicons name="airplane" size={32} color="#FF6EC7" />
						<View className="flex-col">
							<Text className="text-3xl font-extrabold">Flight Ticket</Text>
							<Text className="text-[#3f3f3f]">Keep your flight ticket safe</Text>
						</View>
					</View>

					<View className="mt-4 rounded-xl">
						<Text className="my-6 text-[#3f3f3f] text-center mt-2 text-md leading-tight">Click the picture of the flight ticket, or upload a pdf.</Text>
					</View>

					<View className="mt-6 rounded-xl p-4 bg-white shadow-2xl">
						<Text className="font-semibold text-xl">Upload Ticket</Text>
						<Image source={require('@/assets/images/flight-ticket.jpg')} className="rounded-xl my-3 h-[15rem] w-[100%] object-contain"/>
